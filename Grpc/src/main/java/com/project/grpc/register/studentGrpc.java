...
public final class studentGrpc {
  ...
  public static abstract class studentImplBase implements io.grpc.BindableService {
    ...
    public void login(com.project.grpc.register.User.LoginRequest request,
        io.grpc.stub.StreamObserver<com.project.grpc.register.User.Response> responseObserver) throws SQLException, ClassNotFoundException {
    ...
    public void register(com.project.grpc.register.User.RegisterRequest request,
        io.grpc.stub.StreamObserver<com.project.grpc.register.User.RegResponse> responseObserver) throws SQLException {
        ...
        case METHODID_LOGIN:
          try {
            serviceImpl.login((User.LoginRequest) request,
                    (io.grpc.stub.StreamObserver<User.Response>) responseObserver);
